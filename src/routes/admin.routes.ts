...
import { AdminLogin, CreatAdmin, getAdminController, GetallAdmin } from '../controllers/admin/Admin.Controllers'
...
AdminRoute.get('/me', accessTokenValidatetor, wrapRequestHandler(getAdminController))
