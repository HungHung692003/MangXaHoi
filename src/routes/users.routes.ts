...
UserRouter.get('/profile/:_id', accessTokenValidatetor, wrapRequestHandler(getProfileController))
...
UserRouter.get('/followers/:id', accessTokenValidatetor, wrapRequestHandler(getFollowersController)) //lấy ds tất cả người dùng và đưa lên giao diện để hiện trên follow
