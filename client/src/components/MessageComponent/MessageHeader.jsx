...
export default function MessageHeader({ onClickMessage }) {
  const { user } = useAuth()
    ...
    <div className='lg:w-[456px] w-[300px] border-r border-[#222222]'>
      <div className='flex justify-between items-center p-4 bg-slate-200'>
        ...
        <div className='flex cursor-pointer text-white'>
          ...
          <button className='p-0' onClick={() => setSearch(true)}>
      ...
      <div className='w-full'>
        ...
        {search && <MessageSearch setSearch={setSearch} userList={userList} onClickMessage={onClickMessage} />}
      </div>
