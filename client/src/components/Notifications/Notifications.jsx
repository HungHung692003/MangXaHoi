...
function Notifications() {
  ...
  const handleNotificationClick = (notificationId, tweetId) => {
    ...
    socket.emit('getNotifications', { receiver_id: user._id })
    fetchNotifications()
    navigate(`/tweet/${tweetId}`)
  }

  return (
    <div className='flex overflow-auto flex-col px-px mt-flex max-w-600px h-screen w-[600px] max-lg:mt-0 border-x-2'>
