...
function TweetComposer({ setReload, reload }) {
  ...
  const handleSelectGIF = (gifUrl) => {
    console.log('gifUrl cha ', gifUrl)
    setSelectedGIF(gifUrl)
  }
  console.log('selectGift', selectedGIF)
  return (
    <div className='flex flex-col justify-center px-4 py-2.5 w-full'>
      <div className='flex flex-col w-full max-md:max-w-full'>
        <div className='flex gap-3 self-start text-xl font-medium tracking-tight text-slate-500'>
          ...
          />
          {selectedGIF && <img src={selectedGIF} alt='Selected GIF' className='w-32 h-32 object-cover rounded mb-2' />}
        </div>
        <input
          type='tags'
          placeholder='Hashtag'
        ...
        <div className='flex flex-wrap gap-5 justify-between mt-2.5 max-w-full w-[510px]'>
          <div className='flex-wrap gap-4 items-start my-auto'>
            ...
            <div className='relative'>
              ...
              <button aria-label='Add GIF' onClick={() => setShowModal(true)}>
                <img
                  loading='lazy'
                ...
                />
                {showModal && <ModalGift onClose={() => setShowModal(false)} onSelectGIF={handleSelectGIF} />}
              </button>
