  ...
  return (
    ...
    >
      ...
      {notifications > 0 && text === 'Notifications' && (
        <div className='absolute top-[37%] left-7 bg-red-500 text-white rounded-full text-xs w-5 h-5 flex items-center justify-center'>
          {notifications}
        </div>
      )}
      {message > 0 && text === 'Messages' && (
        <div className='absolute top-[47%] left-7 bg-red-500 text-white rounded-full text-xs w-5 h-5 flex items-center justify-center'>
          {message}
        </div>
      )}
    </div>
